...
export function StatCard({ title, value, icon: Icon, trend, trendLabel, iconColor = 'text-blue-400' }: StatCardProps) {
  const getGradientClass = () => {
    ...
    return 'from-gray-200 dark:from-gray-900 to-gray-100 dark:to-gray-900/50 border-gray-300 dark:border-gray-800 hover:border-gray-600';
  };
  ...
  return (
    <div className={`group relative bg-gradient-to-br ${getGradientClass()} border rounded-2xl p-6 transition-all hover:scale-105 shadow-lg`}>
      <div className="flex items-center justify-between mb-4">
        <div className={`w-14 h-14 rounded-xl bg-gray-200 dark:bg-gray-900/50 flex items-center justify-center ${iconColor} border border-gray-300 dark:border-gray-800 group-hover:border-current transition-all`}>
