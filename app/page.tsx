        ...
        <section className="relative px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Link
                  href="/tokens"
                  className="w-full sm:w-auto px-8 py-4 bg-gray-800 hover:bg-gray-700 text-white font-semibold rounded-lg transition-colors border border-gray-700 text-center"
                >
                  Browse Tokens
                </Link>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-purple-500 transition-colors">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Token Launchpad</h3>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-purple-500 transition-colors">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Livestreaming</h3>
                <p className="text-gray-400">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-purple-500 transition-colors">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">DEX Trading</h3>
                <p className="text-gray-400">
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-purple-500 transition-colors">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Artist Shops</h3>
                <p className="text-gray-400">
