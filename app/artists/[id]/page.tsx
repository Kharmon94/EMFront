          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 flex items-end pb-8">
            <div className="flex items-end gap-6 w-full">
              ...
              <div className="flex-1 pb-2">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-2">{artist.name}</h1>
...
function OverviewTab({ artist, albums, upcoming_events, token, fan_passes }: any) {
  return (
    <div className="space-y-8">
      ...
      {token && (
        <section className="p-6 bg-gradient-to-br from-yellow-900/20 to-orange-900/20 border border-yellow-600/30 rounded-lg">
          <div className="flex justify-between items-start mb-4">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">{token.symbol}</h2>
      ...
      {fan_passes.length > 0 && (
        <section>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Exclusive Fan Passes</h2>
...
function StreamsTab({ recent, upcoming }: any) {
  return (
    <div className="space-y-8">
      {upcoming.length > 0 && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Upcoming Livestreams</h3>
      ...
      {recent.length > 0 && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Recent Streams</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
  ...
  return (
    <Link href={`/albums/${album.id}`}>
      <div className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800 hover:border-purple-600 transition-all group">
        ...
        <div className="p-4">
          <h3 className="font-bold text-gray-900 dark:text-white mb-1 line-clamp-1 group-hover:text-purple-400 transition-colors">{album.title}</h3>
...
function EventCard({ event }: any) {
  return (
    <Link href={`/events/${event.id}`}>
      <div className="p-6 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-purple-600 transition-all">
...
function StreamCard({ stream, upcoming }: any) {
  return (
    <Link href={`/livestreams/${stream.id}`}>
      <div className="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 hover:border-purple-600 transition-all">
        <div className="flex items-start justify-between mb-2">
          <h3 className="font-bold text-gray-900 dark:text-white">{stream.title}</h3>
          {!upcoming && (
  ...
  return (
    <Link href={`/fan-passes/${pass.id}`}>
      <div className="p-6 bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-600/30 rounded-lg hover:border-purple-600 transition-all">
        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{pass.name}</h3>
